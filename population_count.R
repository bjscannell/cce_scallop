...
rstatix::anova_test(data = Graph_mixzinf, dv = fv, wid = time_ID, within = period)




# Break Point Analysis - error using s3 "segmented" on S4 objects (primarily @ replaces use of $)
library(segmented)
